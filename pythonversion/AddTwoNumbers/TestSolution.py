...
class Test(unittest.TestCase):
    ...
    def testAddTwoNumbers_TC8(self):
        #arrange
        headAoj = "{5,1}"
        headBoj = "{5,2}"
    ...
    def testAddTwoNumbers_TC9(self):
        #arrange
        headAoj = "{5,9}"
        headBoj = "{5}"
    ...
    def testAddTwoNumbers_TC10(self):
        #arrange
        headAoj = "{5}"
        headBoj = "{5,9}"
    ...
    def testAddTwoNumbers_TC11(self):
        #arrange
        headAoj = "{1}"
        headBoj = "{5,9,8}"
    ...
    def testAddTwoNumbers_TC12(self):
        #arrange
        headAoj = "{1,3,5}"
        headBoj = "{5}"
