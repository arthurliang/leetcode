...
class Test(unittest.TestCase):
    ...
    def testTwoSum_TC4(self):
        # arrange
        num = [150, 24, 79, 50, 88, 345, 3]
        target = 200
        expRslt = (1, 4)
    ...
    def testSorLlist_TC1(self):
        # arrange
        l = [2, 5, 7, 9, 14]
        expRslt = [2, 5, 7, 9, 14]

        # act
        actRslt = self.testedobj.sortList(l)

        # assert
        self.assertSequenceEqual(expRslt, actRslt)


    def testSorLlist_TC2(self):
        # arrange
        l = [2, 14, 5, 9, 7]
        expRslt = [2, 5, 7, 9, 14]
    ...
    def testSorLlist_TC7(self):
        # arrange
        l = [150, 24, 79, 50, 88, 345, 3]
        expRslt = [3, 24, 50, 79, 88, 150, 345]
    ...
    def testSorLlist_TC8(self):
        # arrange
        l = [2, 1, 9, 4, 4, 56, 90, 3]
        expRslt = [1, 2, 3, 4, 4, 9, 56, 90]
